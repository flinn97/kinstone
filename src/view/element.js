...
class MainContent extends Component{
    ...
    <div style={{display: "flex", flexDirection: "row"}}>
      <div style={{width:"250px"}}>
       ...
       functions={{cells:[0,1], functions:[(component)=>{
        ...
        if(list.length<3){
          state.opps.cleanJsonPrepareRun({addchosenElement:{...component.getJson(), type:"chosenElement"}})
  ...
  <div >
  Chosen Elements
<MapComponent app={app} name="chosenElement" cells={[{img:"picURL", imgStyle:{width:"100px", height:"100px", borderRadius:"50%"}}, "title", "delete" ]}  />
{componentList.getList("chosenElement").length===3&&(
  <div onClick={async()=>{
    ...
    await opps.cleanJsonPrepareRun({addkinstoneComponent:{title:word, picURL:mummy}, })
    opps.prepareRun({del:componentList.getList("chosenElement")})
  }}
