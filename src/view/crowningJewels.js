 ...
 */
export default class CrowningJewels extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div style={{ display: "flex", flexDirection: "row" }}>
        CrowningJewels
        <MapComponent app={app} name="crowningJewel" cells={[{ img: "picURL", imgStyle: { width: "100px", height: "100px", borderRadius: "50%" } }, "title","delete"]} />
